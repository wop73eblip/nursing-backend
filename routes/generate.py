"""CP-SAT 排班生成 + 匯入 DB(/schedule/generate + /schedule/commit)。

這是整個系統最大最複雜的 module,含:
- CP-SAT 建模(H1-H20 + S1-S12)
- SA post-processing 掛入
- LOCAL-RESOLVE 局部改進
- Diag rescue 診斷救援
- H14 軟化 + C1 跨 attr 補償
- Warning 訊息組裝
...
from routes.shifts import ShiftUpdate
